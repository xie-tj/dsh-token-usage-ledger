...
describe('published package', () => {
  ...
  it('packs only the runtime, declarations, composition patch, and package documentation', () => {
    ...
    expect(result.files.map(file => file.path).sort()).toEqual([
      ...
      'lib/types/host/reducer.js',
      'lib/types/host/spec.d.ts',
      'lib/types/host/spec.js',
      'lib/types/host/supervisor.d.ts',
      'lib/types/host/supervisor.js',
      'lib/types/host/types.d.ts',
      'lib/types/host/types.js',
      'lib/types/host/worker-protocol.d.ts',
      'lib/types/host/worker-protocol.js',
      'lib/types/backfill-worker.d.ts',
      'lib/types/backfill-worker.js',
